...
const targetContent = `<div class="header-actions">
                <a href="startup-advisory.html" class="btn btn-primary d-none-mobile">Register for Advisory Session</a>
...
for (const file of files) {
    ...
    if (content.includes('class="header-actions"')) {
        ...
        if (!content.includes('href="login.html" class="btn btn-outline')) {
            ...
            const regex = /<div class="header-actions">\s*<a href="startup-advisory\.html" class="btn btn-primary d-none-mobile">Register for Advisory Session<\/a>\s*<button class="mobile-menu-toggle" id="mobile-menu-toggle" aria-label="Toggle Menu">\s*<i class="fas fa-bars"><\/i>\s*<\/button>\s*<\/div>/g;
